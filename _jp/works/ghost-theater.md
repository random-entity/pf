...
<dl>
  ...
  <dt>ソースコード</dt>
  <dd><span markdown="1">
      [GitHub - 私（任意存在）担当範囲](https://github.com/random-entity/o.art.ghost-theater-snumoa)
  </span></dd>
</dl>
...
- GLPSヘッドホンのハードウェア:
  - GLPSヘッドホンは、既製品のヘッドホンの電子回路に、[PJRC Teensy]をマイクロコントローラとして搭載したPCBを追加装着することで作られる。
