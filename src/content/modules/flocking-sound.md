...
releases:
  - date: "2025-09-29"
    event: Public upload
    venue: "[GitHub public repository](https://github.com/random-entity/o.mod.flocking-sound_processing)"
    version: "[v.processing.0](https://github.com/random-entity/o.mod.flocking-sound_processing/releases/tag/yt-live_2025-09-29)"
  - date: "2025-09-29"
    event: Public upload
    venue: "[YouTube Live](https://youtu.be/MBg5GFYua7Y)"
    version: "[v.processing.0](https://github.com/random-entity/o.mod.flocking-sound_processing/releases/tag/yt-live_2025-09-29)"
type: Module
genre:
...
tools:
  - "Processing"
repo: "[GitHub](https://github.com/random-entity/o.mod.flocking-sound_processing)"
---

[Video](https://youtu.be/MBg5GFYua7Y)

::: en
- This module is a meditation-music generator and a synthesizer created by adding sound and GUI parameter controls to Daniel Shiffman's classic Processing sketch, which implements Craig Reynolds' classic "Boids" algorithm[^boids].
...
::: ko
- Craig Reynolds의 ["Boids" 알고리즘](https://en.wikipedia.org/wiki/Boids)[^boids]을 프로그래밍 한 [Daniel Shiffman의 Processing 스케치](https://processing.org/examples/flocking.html)에, 사운드 모듈과 GUI를 통한 알고리즘 파라미터 조작 기능을 추가하여 만든 명상 음악 생성기이자 신세사이저다.
