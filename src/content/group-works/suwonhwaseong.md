---
title: { en: "Digital Maehwapo", ko: "디지털 매화포", ja: "デジタル梅花砲" }
tagline:
...
releases:
  - { event: "2023 Suwon Hwaseong Media Art – Media Ground", date: "2023-10-06" }
type: Group work
...
- **Format**
  - Genre: Interactive video installation
  - Composition: An interactive video installation played on an LED cube display measuring approximately 2 meters in width, depth, and height, which reacts to the movements of surrounding visitors.
- **Creators**
  - Exhibitor: Hyekang[^2], random-entity
  - Animation: Hyekang
  - Software Development: random-entity
  - Commission: Suwon Cultural Foundation
- **Release**
  - Event: [2023 Suwon Hwaseong Media Art](https://www.swcf.or.kr/hlfl/?p=10) - Media Ground
- **Source code**: [GitHub - Scope in charge of the author (random-entity)](https://github.com/random-entity/o.w.suwonhwaseong)
...
![](images/works/suwonhwaseong/IMG_5496.JPG)
*2023 Suwon Hwaseong Media Art "Media Ground" exhibition scene*

![](images/works/suwonhwaseong/IMG_5489.JPG)
*2023 Suwon Hwaseong Media Art "Media Ground" exhibition scene*
...
![](images/works/suwonhwaseong/IMG_5381.jpeg)
...
- **형식**
  - 장르: 인터랙티브 영상 설치
  - 구성: 가로 세로 높이 약 2미터의 LED 큐브 디스플레이에 재생되며, 주위 관람객의 움직임에 반응하는 인터랙티브 영상 설치
- **만든 사람들**
  - 출품자: 혜강[^2], 임의존재
  - 애니메이션: 혜강
  - 소프트웨어 개발: 임의존재
  - 커미션: 수원문화재단
- **공개**
  - 이벤트: [2023 문화유산 미디어아트 수원화성](https://www.swcf.or.kr/hlfl/?p=10) - 미디어 그라운드
- **소스 코드**: [GitHub - 필자(임의존재) 담당 범위](https://github.com/random-entity/o.w.suwonhwaseong)
...
- **形式**
  ...
  - 構成: 幅・奥行・高さ約2メートルのLEDキューブディスプレイで再生され、周囲の観覧客の動きに反応するインタラクティブ映像インスタレーション
- **制作陣**
  - 出品者: ヘガン[^2]、任意存在
  - アニメーション: ヘガン
  - ソフトウェア開発: 任意存在
  - コミッション: 水原文化財団
- **公開**
  - イベント: [2023 文化遺産メディアアート水原華城](https://www.swcf.or.kr/hlfl/?p=10) - メディアグラウンド
- **ソースコード**: [GitHub - 私（任意存在）担当範囲](https://github.com/random-entity/o.w.suwonhwaseong)
