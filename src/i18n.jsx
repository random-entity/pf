...
const UI = {
  en: {
    ...
    markMissing: 'Hiding items without a value',
    filterByTags: 'Filter by tags',
    tagAny: 'Any',
    tagAll: 'All',
    allExclusive: 'These values never occur together — “All” would match nothing',
  ...
  ko: {
    ...
    markMissing: '값 없는 항목 숨김',
    filterByTags: '태그로 필터',
    tagAny: '하나라도',
    tagAll: '모두',
    allExclusive: '이 값들은 함께 나타나지 않습니다 — “모두”는 결과가 없습니다',
    noResults: '결과 없음.',
    noHeadings: '제목 없음.',
    home: '홈',
  ...
  ja: {
    ...
    markMissing: '値なしの項目を非表示',
    filterByTags: 'タグで絞り込み',
    tagAny: 'いずれか',
    tagAll: 'すべて',
    allExclusive: 'これらの値は同時に存在しません — 「すべて」は該当なしになります',
    noResults: '結果なし。',
    noHeadings: '見出しなし。',
    home: 'ホーム',
    notFound: '作品が見つかりません。',
