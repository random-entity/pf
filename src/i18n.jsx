...
const UI = {
  en: {
    ...
    menu: 'Menu',
    items: 'items',
    props: { title: 'Title', date: 'Date', created: 'Created', genre: 'Genre', medium: 'Medium', dimensions: 'Dimensions', year: 'Year', tags: 'Tags', location: 'Location', status: 'Status' },
  },
  ko: {
    siteTitle: '포트폴리오',
    files: '파일',
    ...
    menu: '메뉴',
    items: '개',
    props: { title: '제목', date: '날짜', created: '제작일', genre: '장르', medium: '재료', dimensions: '크기', year: '연도', tags: '태그', location: '위치', status: '상태' },
  },
  ja: {
    siteTitle: 'ポートフォリオ',
    files: 'ファイル',
    ...
    menu: 'メニュー',
    items: '件',
    props: { title: 'タイトル', date: '日付', created: '制作日', genre: 'ジャンル', medium: '素材', dimensions: 'サイズ', year: '年', tags: 'タグ', location: '場所', status: 'ステータス' },
  },
}
